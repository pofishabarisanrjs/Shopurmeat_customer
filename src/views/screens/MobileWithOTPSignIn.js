...
const MobileWithOTPScreen = ({ navigation, route }) => {
    ...
    const { isLoading, userInfo, MobileWithOTPScreen, googlelogin, signOut, verifyotpAPI, ResendOTP } = useContext(AuthContext);
    ...
    const submit = () => {
        ...
        if (email == null)
            ...
            return Validatenav(fromcart), MobileWithOTPScreen(email, (data) => {
                ...
                else if (data?.need_email_verification === true ) {
